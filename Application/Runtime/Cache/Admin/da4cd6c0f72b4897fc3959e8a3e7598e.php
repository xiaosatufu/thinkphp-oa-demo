        ...
        <div class="hd-wrap ue-clear">
            ...
            <div class="login-info ue-clear">
                ...
                <div class="login-msg ue-clear">
                    <a href="<?php echo U('Email/recBox');?>" class="msg-txt" target="iframe">消息</a>
                    <a href="javascript:;" class="msg-num">0</a>
                </div>
            </div>
    ...
    <div id="bd">
        <div class="wrap ue-clear">
            ...
            <div class="content">
                ...
                <iframe src="<?php echo U('home');?>" id="iframe" name="iframe" width="100%" height="100%" frameborder="0"></iframe>
            </div>
        </div>
    </div>
